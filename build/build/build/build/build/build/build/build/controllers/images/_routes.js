...
router.put("/change-logoImg/:id", auth, img.upload.fields([{
  name: 'logoSmImg',
  maxCount: 1
}, {
  name: 'logoLgImg',
...
router.post("/add-auth-logo-img", auth, img.upload.fields([{
  name: 'authImg',
  maxCount: 1
}, {
  name: 'logoSmImg',
...
router.put("/change-auth-logo-img/:id", auth, img.upload.fields([{
  name: 'authImg',
  maxCount: 1
}, {
  name: 'logoSmImg',
