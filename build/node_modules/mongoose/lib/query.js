...
const printRawResultDeprecationWarning = util.deprecate(function printRawResultDeprecationWarning() {}, 'The `rawResult` option for Mongoose queries is deprecated. Use `includeResultMetadata: true` as a replacement for `rawResult: true`.');

/*!
 * ignore
 */

const printOverwriteDeprecationWarning = util.deprecate(function printOverwriteDeprecationWarning() {}, 'The `overwrite` option for `findOneAndUpdate()` is deprecated. use `findOneAndReplace()` instead.');
